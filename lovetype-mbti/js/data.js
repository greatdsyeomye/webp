...
const qnaList = [
  ...
  },
  {
    ...
    a: [
      { answer: 'a. 바로 먼저 연락한다.', type: [0, 3, , 8] },
  ...
  },
  {
    q: '3. 당신의 고백 스타일은?',
    a: [
      { answer: 'a. 호감이 보이면 바로 고백한다', type: [1, 3, , 10, 8] },
...

  {
    ...
    a: [
      ...
      { answer: 'c. 이미 깜짝 이벤트 다 준비해놨어', type: [1, 7, , 5, 8 ] },
    ]
  },
  {
  ...
  },
  {
    ...
    a: [
      ...
      { answer: 'b. 연인이 살고 있는 집의 역이나 정류장까지 데려다준다.', type: [3, , 6, 5, 10, 8 ] },
  ...
  },
  {
    ...
    a: [
      ...
      { answer: 'b. 아 그래?? 나 할 것들 좀만 마무리하고 나갈게', type: [0, , 6, 5 ] },
  ...
  },
  {
    ...
    a: [
      ...
      { answer: 'b. "야! 너 화내지마. 너 잘못이지. 내가 뭘 잘못했는데?" 소리지르며 끝까지 불같이 화낸다.', type: [0, , 5, 10, 8] },
